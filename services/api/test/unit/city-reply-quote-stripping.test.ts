...
describe("cityReplyChatBody: quoted history in every client's shape", () => {
  it.each([
    [
      "Gmail, wrapped",
      reply("On Tue, Sep 22, 2026 at 8:47 PM civfix Reports <", `${ADDR}> wrote:`),
    ],
    [
      "Gmail, wrapped twice",
      reply("On Tue, Sep 22, 2026 at 8:47 PM", "civfix Reports", `<${ADDR}> wrote:`),
    ...
    [
      "Gmail reply-all, a sender named Le",
      reply("On Tue, Sep 22, 2026 at 8:47 PM", "Le Thi Nguyen <clerk@testville.gov> wrote:"),
    ],
    [
      "Gmail, wrapped twice, a sender named El",
      reply("On Tue, Sep 22, 2026 at 8:47 PM", "El Segundo", "<pw@testville.gov> wrote:"),
    ],
    ...
    [
      "Gmail de, wrapped",
      reply("Am Di., 22. Sept. 2026 um 20:47 Uhr schrieb civfix Reports <", `${ADDR}>:`),
    ],
    ...
    [
      "Outlook",
      reply("________________________________", `From: civfix Reports <${ADDR}>`, "Sent: Tuesday"),
    ],
    [
      "Outlook es",
      reply("________________________________", `De: civfix Reports <${ADDR}>`, "Enviado: martes"),
    ],
    ...
    [
      "Gmail forward",
      reply("---------- Forwarded message ---------", `From: civfix Reports <${ADDR}>`),
    ],
    [
      "a forward of other mail",
      reply("---------- Forwarded message ---------", "From: Crew <c@x.gov>"),
    ],
  ...
  it("keeps a top-posted reply's inline links and an address-less two-line 'On … wrote:'", () => {
    const top =
      "Tracked at <https://testville.gov/t/4821>\nOn Monday the crew\nwrote:\n- curb cleared"
  ...
  it.each([
    ...
    [
      "On it.\nCrew will come tomorrow.",
      "On Tue, Sep 22, 2026 at 8:47 PM Clerk <clerk@testville.gov> wrote:",
    ],
    [
      "El camión pasará mañana.",
      `El mar, 22 sept 2026 a las 20:47, civfix Reports (<${ADDR}>) escribió:`,
    ],
    [
      "Am Mittwoch kommt der Wagen.",
      `Am Di., 22. Sept. 2026 um 20:47 Uhr schrieb civfix Reports <${ADDR}>:`,
    ],
    [
      "Bonjour,\nLe camion passera demain.",
      `Le mar. 22 sept. 2026 à 20:47, civfix Reports <${ADDR}> a écrit :`,
    ],
