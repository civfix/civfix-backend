...
import { clampLimit, decodeCursor, type CursorAnchor } from "./pagination.js"
import { INBOUND_AUTH_VERDICT_HEADER } from "./inbound-repository.drizzle.js"
...
import { replyPublication } from "./mail-mappers.js"
import {
  ...
  type InboxFeedRow,
} from "./inbox-feed-repository.drizzle.js"
...
function isBefore(row: InboxFeedRow, anchor: CursorAnchor): boolean {
