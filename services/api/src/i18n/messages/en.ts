...
export const en = {
  ...
  // (volunteer-hours-service.ts: organizer/cohost gate, actor-must-be-verified, self-credit block). Do
  ...
  "certificate.attestation.body":
    "This record was generated by civfix from its volunteer-service ledger. Hours for an event are entered by that event's host, who must be an identity-verified organizer and who cannot credit hours to themselves. The authoritative record is the one held by civfix; confirm this document at the address below.",
