...
export const en = {
  ...
  // (volunteer-hours-service.ts: organizer/cohost gate, actor-must-be-verified, self-credit block, the
  // automatic report award). Do not soften or embellish it — an untrue attestation on an official
  // document is the worst failure mode this feature has.
  //
  ...
  "certificate.holder.verified": "Identity-verified community member",
  ...
  "certificate.attestation.body":
    "This record was generated by civfix from its volunteer-service ledger. Hours for an event are entered by that event's host, who must be an identity-verified organizer and who cannot credit hours to themselves. Report-verification hours are awarded automatically by the platform. The authoritative record is the one held by civfix; confirm this document at the address below.",
