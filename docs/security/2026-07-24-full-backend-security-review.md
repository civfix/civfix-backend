...
`drizzle/` holds **147 files**, `0000_extensions.sql` … `0167_org_payouts.sql`. The nine rows
...
`ALTER TABLE … VALIDATE CONSTRAINT`. They are correct as `NOT VALID` — the constraint is enforced for
